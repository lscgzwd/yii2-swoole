...
class HTML extends BaseWriter implements IWriter
{
    ...
    private function setMargins(\PHPExcel\Worksheet $pSheet)
    {
        ...
        $left = Str::FormatNumber($pSheet->getPageMargins()->getLeft()) . 'in; ';
        $htmlPage .= 'margin-left: ' . $left;
        $htmlBody .= 'margin-left: ' . $left;
        $right = Str::FormatNumber($pSheet->getPageMargins()->getRight()) . 'in; ';
        $htmlPage .= 'margin-right: ' . $right;
        $htmlBody .= 'margin-right: ' . $right;
        $top = Str::FormatNumber($pSheet->getPageMargins()->getTop()) . 'in; ';
        $htmlPage .= 'margin-top: ' . $top;
        $htmlBody .= 'margin-top: ' . $top;
        $bottom = Str::FormatNumber($pSheet->getPageMargins()->getBottom()) . 'in; ';
