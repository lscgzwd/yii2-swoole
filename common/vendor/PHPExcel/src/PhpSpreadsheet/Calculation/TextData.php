...
class TextData
{
    ...
    public static function SEARCHSENSITIVE($needle, $haystack, $offset = 1)
    {
        ...
        if (!is_bool($needle)) {
            ...
            if (($offset > 0) && (\PHPExcel\Shared\Str::CountCharacters($haystack) > $offset)) {
                if (\PHPExcel\Shared\Str::CountCharacters($needle) == 0) {
                    return $offset;
                }
    ...
    public static function LOWERCASE($mixedCaseString)
    {
        ...
        return \PHPExcel\Shared\Str::StrToLower($mixedCaseString);
    }
    ...
    public static function UPPERCASE($mixedCaseString)
    {
        ...
        return \PHPExcel\Shared\Str::StrToUpper($mixedCaseString);
    }
    ...
    public static function PROPERCASE($mixedCaseString)
    {
        ...
        return \PHPExcel\Shared\Str::StrToTitle($mixedCaseString);
    }
    ...
    public static function VALUE($value = '')
    {
        ...
        if (!is_numeric($value)) {
            $numberValue = str_replace(
                \PHPExcel\Shared\Str::getThousandsSeparator(),
                '',
                trim($value, " \t\n\r\0\x0B" . \PHPExcel\Shared\Str::getCurrencyCode())
            );
