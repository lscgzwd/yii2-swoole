...
return [
    ...
    'yiiswoole\web\Controller'                     => VENDOR_PATH . '/yii2-swoole/src/web/Controller.php',
    'yiiswoole\web\ErrorHandler'                   => VENDOR_PATH . '/yii2-swoole/src/web/ErrorHandler.php',
    'yiiswoole\web\Request'                        => VENDOR_PATH . '/yii2-swoole/src/web/Request.php',
    'yiiswoole\web\Response'                       => VENDOR_PATH . '/yii2-swoole/src/web/Response.php',
    'yiiswoole\web\Session'                        => VENDOR_PATH . '/yii2-swoole/src/web/Session.php',
    'yiiswoole\web\User'                           => VENDOR_PATH . '/yii2-swoole/src/web/User.php',
    'yiiswoole\db\Command'                         => VENDOR_PATH . '/yii2-swoole/src/db/Command.php',
    'yiiswoole\db\Connection'                      => VENDOR_PATH . '/yii2-swoole/src/db/Connection.php',
    'yiiswoole\redis\Connection'                   => VENDOR_PATH . '/yii2-swoole/src/redis/Connection.php',
    'yiiswoole\redis\Session'                      => VENDOR_PATH . '/yii2-swoole/src/redis/Session.php',
    'yiilog\EmailTarget'                           => VENDOR_PATH . '/yii2-log/src/EmailTarget.php',
    'yiilog\RedisTarget'                           => VENDOR_PATH . '/yii2-log/src/RedisTarget.php',
    'yiilog\LogstashFileTarget'                    => VENDOR_PATH . '/yii2-log/src/LogstashFileTarget.php',
